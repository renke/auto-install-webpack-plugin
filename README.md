__ATTENTION: This repository is deprecated. See [npm-install-webpack-plugin](https://github.com/ericclemmons/npm-install-webpack-plugin) for way better alternative.__
